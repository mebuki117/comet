...
# sound
execute as @a at @s align xz at @s[y_rotation=-45..45] if score @s random matches 6 run playsound minecraft:entity.wither.spawn hostile @s ~ ~ ~5
execute as @a at @s align xz at @s[y_rotation=45..135] if score @s random matches 6 run playsound minecraft:entity.wither.spawn hostile @s ~-5 ~ ~
execute as @a at @s align xz at @s[y_rotation=135..225] if score @s random matches 6 run playsound minecraft:entity.wither.spawn hostile @s ~ ~ ~-5
execute as @a at @s align xz at @s[y_rotation=225..315] if score @s random matches 6 run playsound minecraft:entity.wither.spawn hostile @s ~5 ~ ~
